...
SET(INSTALL_BINDIR bin${libext})
IF(WIN32)
    SET(INSTALL_LIBDIR bin${libext})
    SET(INSTALL_ARCHIVEDIR lib${libext})
ELSE()
...
IF(MSVC AND DYNAMIC_OPENSCENEGRAPH)
    ...
    INSTALL(FILES ${OUTPUT_BINDIR}/${PREFIX}${LIB_NAME}${CMAKE_UNOPTIMIZED_POSTFIX}.pdb DESTINATION ${INSTALL_BINDIR} COMPONENT libopenscenegraph CONFIGURATIONS Unoptimized)
