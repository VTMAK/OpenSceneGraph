...
#the installation path are differentiated for win32 that install in bib versus other architecture that install in lib${libext}/${OSG_PLUGINS}
    IF(WIN32)
        ...
        IF(MSVC AND DYNAMIC_OPENSCENEGRAPH)
            ...
            INSTALL(FILES ${OUTPUT_BINDIR}/${OSG_PLUGINS}/${TARGET_TARGETNAME}${CMAKE_UNOPTIMZED_POSTFIX}.pdb DESTINATION bin${libext}/${OSG_PLUGINS} COMPONENT ${PACKAGE_COMPONENT} CONFIGURATIONS Unoptimized)
...
MACRO(SETUP_APPLICATION APPLICATION_NAME)
        ...
        ELSE(APPLE)
            ...
            IF(MSVC)
                ...
                INSTALL(FILES ${OUTPUT_BINDIR}/${TARGET_NAME}${CMAKE_UNOPTIMZED_POSTFIX}.pdb DESTINATION bin${libext} COMPONENT openscenegraph CONFIGURATIONS Unoptimized)
...
MACRO(SETUP_EXAMPLE EXAMPLE_NAME)
        ...
        ELSE(APPLE)
            ...
            IF(MSVC)
                ...
                INSTALL(FILES ${OUTPUT_BINDIR}/${TARGET_NAME}${CMAKE_UNOPTIMZED_POSTFIX}.pdb DESTINATION share/OpenSceneGraph/bin${libext} COMPONENT openscenegraph-examples CONFIGURATIONS Unoptimized)
