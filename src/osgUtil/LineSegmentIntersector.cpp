...
namespace LineSegmentIntersectorUtils
{
    ...
    struct TriangleIntersector
    {
        ...
        inline void operator () (const osg::Vec3& v1,const osg::Vec3& v2,const osg::Vec3& v3, bool treatVertexDataAsTemporary)
        {
            ...
            typename Vec3::value_type* orig = &_s[0];
            osg::Vec3::value_type* vert0 = &(*(const_cast<osg::Vec3*>(&v1)))[0];
            osg::Vec3::value_type* vert1 = &(*(const_cast<osg::Vec3*>(&v2)))[0];
            osg::Vec3::value_type* vert2 = &(*(const_cast<osg::Vec3*>(&v3)))[0];
            typename Vec3::value_type* dir = &_d[0];
            double* t = &r1;
            double* u = &r2;
            double* v = &r3;
