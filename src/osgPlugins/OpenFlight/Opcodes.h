...
enum Opcodes
{
    ...
    EXTENDED_MATERIAL_HEADER_OP         = 135,
    EXTENDED_MATERIAL_AMBIENT_OP			 = 136,
    EXTENDED_MATERIAL_DIFFUSE_OP			 = 137,
    EXTENDED_MATERIAL_SPECULAR_OP		 = 138,
    EXTENDED_MATERIAL_EMISSIVE_OP       = 139,
    EXTENDED_MATERIAL_ALPHA_OP			 = 140,
    EXTENDED_MATERIAL_LIGHT_MAP_OP      = 141,
    EXTENDED_MATERIAL_NORMAL_MAP_OP     = 142,
    EXTENDED_MATERIAL_BUMP_MAP_OP       = 143,
    EXTENDED_MATERIAL_SHADOW_MAP_OP     = 145,
    EXTENDED_MATERIAL_REFLECTION_MAP_OP = 147,
    EXTENDED_MATERIAL_PHYSICAL_MATERIAL_OP = 155,
};
